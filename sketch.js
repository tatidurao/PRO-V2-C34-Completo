...
function draw() {
  ...
  /*print(animationSprite)

  if(collide(fruit,star,20)==true )
  {
   if (animationSprite == 1){
     animationSprite = "star1"
   }    
      print(animationSprite)
  }
  if(collide(fruit,star2,40)==true )
  {
   if (animationSprite == 1){
     animationSprite = "star2"
   }
   if( animationSprite == "star1"){
     animationSprite = "duas"
   } 
      print(animationSprite)
  }
  ...
  } else if(animationSprite === "star2"){
   star_display.changeAnimation('one');
   star2.visible = false;
   
   
  } else if(animationSprite == "duas"){
   star_display.changeAnimation('two');
   star2.visible = false;
